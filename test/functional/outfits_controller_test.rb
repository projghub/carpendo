...
class OutfitsControllerTest < ActionController::TestCase
  ...
  test "should create outfit" do
    assert_difference('Outfit.count') do
      post :create, outfit: { description: @outfit.description, name: @outfit.name, user_id: @outfit.user_id }
    end
  ...
  test "should update outfit" do
    put :update, id: @outfit, outfit: { description: @outfit.description, name: @outfit.name, user_id: @outfit.user_id }
    assert_redirected_to outfit_path(assigns(:outfit))
  end
